...
def load_mock_response(file_name: str) -> str:
    ...
    """
    with open(os.path.join('test_data/outputs', file_name), mode='r', encoding='utf-8') as mock_file:
...
@pytest.mark.parametrize('response_file_name,command_arguments,expected_outputs_len,expected_message_id',
                         [(
...
def test_spam_quarantine_message_search_command(
    ...
    expected_message_id, requests_mock, mock_client
    ):
    """
...
@pytest.mark.parametrize('response_file_name,command_arguments,expected_message_id',
                         [(
...
def test_spam_quarantine_message_get_command(
    response_file_name, command_arguments, expected_message_id, requests_mock, mock_client
    ):
    """
...
# @pytest.mark.parametrize('command_arguments,expected_message',
#                          [(
#                              {
#                                  'message_ids': [50, 51]
#                              },
#                              'Quarantined message 50, 51 successfully released.',
#                          )])
...
@pytest.mark.parametrize('response_file_name,command_arguments,expected_outputs_len,expected_recipient_address',
                         [(
                             'list_entry_get.json',
                             {
...
def test_list_entry_get_command(
    response_file_name, command_arguments, expected_outputs_len,
    expected_recipient_address, requests_mock, mock_client
    ):
    """
...
def test_message_search_command(
    response_file_name, command_arguments, expected_outputs_len,
    expected_message_id, expected_recipients, requests_mock, mock_client
    ):
    """
...
def test_message_details_get_command(
    ...
    expected_recipients, expected_summary_len, requests_mock, mock_client
    ):
    """
...
def test_message_amp_details_get_command(
    response_file_name, command_arguments, expected_message_id,
    expected_recipients, expected_amp_summary_len, requests_mock, mock_client
    ):
    """
...
def test_message_dlp_details_get_command(
    response_file_name, command_arguments, expected_message_id, expected_recipients,
    expected_dlp_policy, requests_mock, mock_client
    ):
    """
...
def test_message_url_details_get_command(
    response_file_name, command_arguments, expected_message_id,
    expected_recipients, expected_url_summary_len, requests_mock, mock_client
    ):
    """
...
def test_message_report_get_command(
    response_file_name, command_arguments, expected_type,
    expected_results_len, requests_mock, mock_client
    ):
    """
    Scenario: Report get.
    Given:
